...
windowAction.set(26215, { type: 'cast', window: [500, 30], battleOnce: true }) // 绝龙诗 P6：尼德霍格 v2
windowAction.set(29050, { type: 'begincast', window: [200, 30], battleOnce: true }) // 绝龙诗 P6.5：双眼 v2
...
windowAction.set(0x4a8b, { type: 'cast', window: [900, 200], syncOnce: true, battleOnce: true }) // 未知
...
windowAction.set(0xa38f, { type: 'cast', window: [60, 60], syncOnce: true, battleOnce: true }) // 中段
windowAction.set(0xa82d, { type: 'cast', window: [60, 60], syncOnce: true, battleOnce: true }) // 同步点
