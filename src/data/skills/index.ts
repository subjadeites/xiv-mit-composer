...
export const SKILLS: Skill[] = [
    ...
    { id: 'pld-reprisal', name: '雪仇', cooldownSec: 60, durationSec: 15, job: 'PLD', color: 'bg-blue-500', actionId: 1193 },
    ...
    { id: 'war-reprisal', name: '雪仇', cooldownSec: 60, durationSec: 15, job: 'WAR', color: 'bg-red-500', actionId: 1193 },

    // 暗黑骑士 (DRK)
    { id: 'drk-rampart', name: '铁壁', cooldownSec: 90, durationSec: 20, job: 'DRK', color: 'bg-purple-500', actionId: 7531 },
    { id: 'drk-dark-mind', name: '弃明投暗', cooldownSec: 60, durationSec: 10, job: 'DRK', color: 'bg-purple-500', actionId: 1191 },
    ...
    { id: 'drk-reprisal', name: '雪仇', cooldownSec: 60, durationSec: 15, job: 'DRK', color: 'bg-purple-500', actionId: 1193 },
    ...
    { id: 'gnb-reprisal', name: '雪仇', cooldownSec: 60, durationSec: 15, job: 'GNB', color: 'bg-orange-500', actionId: 1193 },
];
